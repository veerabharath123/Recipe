...
namespace Recipe.Helpers
{
    ...
    public sealed class RazorViewToStringRenderer : IRazorViewToStringRenderer
    {
        ...
        public async Task<FileDownload> GeneratePdfFile<TModel>(string viewName, TModel model,string filename)
        {
            string view = await RenderViewToStringAsync(viewName, model);
            var renderer = new ChromePdfRenderer();
            var pdf = renderer.RenderHtmlAsPdf(view);
            return new FileDownload { filedata = pdf.Stream.ToArray(),filename = filename + ".pdf" };
        }
    ...
    public interface IRazorViewToStringRenderer
    {
        ...
        Task<FileDownload> GeneratePdfFile<TModel>(string viewName, TModel model, string filename);
    }
}
